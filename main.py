...
parser.add_argument('--train_pos', default=False, action='store_true', help='train for object positions')
...
parser.add_argument('--adapt_training_on_large_graph', default=False, action='store_false', help='if adapt acceleration on on large graphs')
parser.add_argument('--max_scene_nodes', type=int, default=200, help='(if adpat accelecration) max number of nodes under the root node. if exceed, split into subgraphs')

# room type settings
parser.add_argument('--room_type', type=str, default='classroom', help='room type, choice=[bedroom, living, bathroom, office]')
parser.add_argument('--num_train_rooms', default=304, type=int, help='number of rooms for training')
parser.add_argument('--num_test_rooms', default=76, type=int, help='number of rooms for testing')
